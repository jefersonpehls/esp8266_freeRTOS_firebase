...
static void https_write_task (void *pvParameters)
{
    ...
    ///////////
    strcpy (writeREQUEST, "GET "WEB_URL" HTTP/1.0\r\n");
    strcat (writeREQUEST, "Host: "WEB_SERVER"\r\n");
    strcat (writeREQUEST, "User-Agent: esp-idf/1.0 esp32\r\n");
    strcat (writeREQUEST, "Accept: text/event-stream\r\n");
    strcat (writeREQUEST, "\r\n");
    ///////////
...
void app_main(void)
{
    ...
    //xTaskCreate(&https_monitor_task, "https_monitor_task", 8192, NULL, 5, NULL);
